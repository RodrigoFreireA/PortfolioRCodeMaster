      ...
      'bg-white dark:bg-slate-800': !scrollBg,
        ...
        <div class="container flex flex-wrap items-center justify-between mx-auto">
            <a href="#" class="flex items-center">
                <img src="http://127.0.0.1:8000/img/logo.png" class="h-6 mr-3 sm:h-9" alt="Flowbite Logo" />
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Rodrigo - Portfolio</span>
            </a>
            ...
            <div class="w-full md:block md:w-auto" :class="{ hidden: showMobileMenu }" id="navbar-default">
                <ul
                    class="flex flex-col p-4 mt-4 border border-light-tail-500 dark:border-dark-navy rounded-lg md:flex-row md:space-x-8 md:mt-0 md:font-medium md:border-0 dark:border-gray-700">
